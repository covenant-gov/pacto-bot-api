...
- **R12** — tests/integration_test.rs, tests/mls_group.rs, tests/multi_bot.rs, tests/nostr_client.rs
...
| R12 | The daemon sends and receives NIP-17/44/59 DMs (gift wrap pipeline) for each registered bot identity. | tests/nostr_client.rs<br>tests/integration_test.rs<br>tests/mls_group.rs<br>tests/multi_bot.rs | src/nostr.rs<br>src/bot_state.rs | — | ✅ covered |
